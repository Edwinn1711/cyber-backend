...
{/* VIEW ASSESSMENT (REVISI: TARGET DOMAINS) */}
{view === 'assessment' && (
              <motion.div key="assess-hub" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="max-w-[1550px] mx-auto space-y-20 py-12">
                ...
                <div className="text-center space-y-6 relative">
                  ...
                  {/* JUDUL DIGANTI JADI TARGET DOMAINS */}
                      ...
                      <div className="relative z-10 flex flex-col h-full">
                        <div className="flex justify-between items-start mb-16">
                           <div className="space-y-2 text-left">
                              {/* LABEL DIGANTI JADI DOMAIN ALPHA/BRAVO/CHARLIE */}
                              <p className="text-[10px] font-mono text-slate-500 tracking-[0.4em] uppercase">{domain.label}</p>
                              <div className="flex items-center gap-2">
                                 <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_10px_#10b981]" />
                                 <span className="text-[8px] font-black text-emerald-400 tracking-[0.5em] uppercase">Status Online</span>
                              </div>
                           </div>
                           <div className="w-16 h-16 rounded-[2rem] bg-white/5 border border-white/10 flex items-center justify-center transition-all duration-700 group-hover:bg-black group-hover:rotate-12">
                        ...
                        <div className="mt-20 pt-10 border-t border-white/5 flex items-end justify-between">
                           ...
                           <div className="flex items-center gap-5 text-cyan-400 group-hover:text-white transition-all">
