  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-black text-slate-200 overflow-x-hidden selection:bg-fuchsia-500/30 relative">
      ...
      <main className="relative z-10 w-full pt-24 lg:pt-44">
        ...
        <section className="relative w-full bg-[#030208] z-20 pb-32 pt-24 border-b border-white/5 shadow-2xl">
          <div className="max-w-[1600px] mx-auto px-6 lg:px-16 relative z-10 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {[ { t: "Infrastruktur", i: Server, c: "text-cyan-400", d: "Membangun arsitektur jaringan sekolah yang terpusat." }, { t: "Keamanan", i: ShieldAlert, c: "text-fuchsia-400", d: "Menerapkan protokol enkripsi pemantauan real-time." }, { t: "Literasi", i: BrainCircuit, c: "text-emerald-400", d: "Meningkatkan kesadaran keamanan data pribadi." } ].map((item, i) => (
                <div key={i} className="bg-[#08070d]/80 border border-white/5 p-12 rounded-[3rem] hover:border-white/20 transition-all">
